	...
	<body>
		<header>
			<div id="cabezota">
				...
				<div id="logoMain">
					<a href="main.php"; ><img id="logounillanos" src="img/logounillanos.jpg" ondragstart="return false"></a>
				</div>
					...
					<nav id="">	
						<div class="lighter">
							<form id="formbuscar" method="get" action="#"> 
								<span><input id="busca" type="search" name="clave" results="5" class="search rounded" placeholder="Buscar por nombre de Instituci&oacute;n ..."
					...
					<!-- <nav id="menu">	
						<ul class="lista">
							<li><a href="#"><img src="img/nuevo3.png" alt="Nuevo" title="Nuevo" ondragstart="return false"></a>
								<ul>
									<li id="nuevoEst"><a href="#"></a></li>
									<li id="nuevoDoc"><a href="#"></a></li>
								</ul>	
							</li>
						</ul>
					</nav>  -->
